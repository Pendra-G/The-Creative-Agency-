...
const STEPS = [
  {
    n: 1,
    title: "We talk",
    body: "One call, thirty minutes, no charge. You tell me what the site has to do and who it has to convince. If a one-pager isn't right for you, I'll say so on that call rather than sell you one.",
  },
  {
    n: 2,
    title: "We design",
  ...
  },
  {
    n: 3,
    title: "We launch",
    body: "Built, animated, tested and live. Your domain pointed at it and the keys handed over. About two weeks from that first call, start to finish.",
  },
];
    ...
    <section id="process" ref={root} className="bg-ink py-20 sm:py-28 lg:py-36">
      <div className="mx-auto w-full max-w-shell px-4 sm:px-6">
        <div className="pr-head flex flex-wrap items-end justify-between gap-6 border-b border-line pb-8">
          <h2 className="display text-cream text-[clamp(2.4rem,10vw,8rem)]">How it works</h2>
          <p className="micro text-cream/50">Three steps · About two weeks</p>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-10 lg:grid-cols-[16rem_1fr] lg:gap-20">
          ...
          <div className="hidden lg:block">
            <div className="sticky top-32">
              <p className="display text-[10rem] leading-[0.8] text-gold">
                {String(active).padStart(2, "0")}
              </p>
              <p className="mt-4 micro text-cream/45">of 03</p>
              <div className="mt-8 h-px w-full bg-line">
                <div
                  className="h-px bg-gold transition-all duration-500 ease-spring"
            ...
            {STEPS.map((s) => (
              ...
              >
                <div className="flex items-baseline gap-5">
                  <span className="micro text-gold lg:hidden">
                    {String(s.n).padStart(2, "0")}
                  </span>
                  <h3 className="display text-cream text-[clamp(2rem,7vw,4.5rem)]">{s.title}</h3>
                </div>
